    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    base_path('public/build/assets/images/clientes'),
                    base_path('public/build/assets/images/clientes_executivos'),
                    base_path('public/build/assets/images/fornecedores'),
                    base_path('public/build/assets/images/funcionarios'),
                    base_path('public/build/assets/images/users'),
                    base_path('public/build/assets/images/visitas_tecnicas'),

                    base_path('public/build/assets/pdfs/clientes'),
                    base_path('public/build/assets/pdfs/clientes_executivos'),
                    base_path('public/build/assets/pdfs/funcionarios'),
