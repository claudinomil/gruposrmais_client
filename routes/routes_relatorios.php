...
Route::prefix('relatorios')->group(function () {
    ...
    Route::get('relatorio10/{produto_id}/{produto_categoria_id}/{estoque_local_id}/{empresa_id}/{cliente_id}/{produto_situacao_id}/{idioma}', [RelatorioController::class, 'relatorio10'])->name('relatorios.relatorio10');
});
