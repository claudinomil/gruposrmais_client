...
function vtt1_removerFotografia(button) {
    const visita_tecnica_dado_id = button.dataset.vtt1_visita_tecnica_dado_id;
    const slot = button.dataset.vtt1_slot;
...
function vtt1_observacaoFotografiaPdfShow() {
    ...
    observacaoFotografiasPdfs.forEach(element => {
        const visita_tecnica_dado_id = element.getAttribute('data-vtt1_visita_tecnica_dado_id');
...
function vtt1_gerarHtmlPerguntas(visitas_tecnicas_dados) {
    ...
    visitas_tecnicas_dados.forEach(dado => {
        ...
        html += `
            ...
            <div class="row classObservacaoFotografiaPdf" id="vtt1_divObservacaoFotografiaPdf_${dado.id}" data-vtt1_visita_tecnica_dado_id="${dado.id}" style="display: ${vtt1_divObservacaoFotografiaPdf_display};">
                <hr class="ms-3 my-2" />`;
            ...
            for (let i = 1; i <= 3; i++) {
                ...
                html += `
                    <div class="m-2 d-inline-block text-center position-relative container-foto" style="${display_fotografia}">
                        <button type="button" class="btn btn-sm btn-success position-absolute top-0 start-0 p-0 px-1 visualizar-foto" style="${display_fotografia}" data-vtt1_visita_tecnica_dado_id="${dado.id}" data-vtt1_slot="${i}"><i class="fas fa-search"></i></button>
                ...
                if (operacao != 'view') {
                    html += `
                        <button type="button" class="btn btn-sm btn-danger position-absolute top-0 end-0 p-0 px-1 remover-foto" style="${display_fotografia}" data-vtt1_visita_tecnica_dado_id="${dado.id}" data-vtt1_slot="${i}"><i class="fas fa-times"></i></button>
                    `;
                }
            ...
            for (let i = 1; i <= 3; i++) {
                ...
                html += `
                    <div class="m-2 d-inline-block text-center position-relative container-pdf" style="${display_pdf}">
                        <button type="button" class="btn btn-sm btn-success position-absolute top-0 start-0 p-0 px-1 visualizar-pdf" style="${display_pdf}" data-vtt1_visita_tecnica_dado_id="${dado.id}" data-vtt1_slot="${i}"><i class="fas fa-search"></i></button>
                ...
                if (operacao != 'view') {
                    html += `
                        <button type="button" class="btn btn-sm btn-danger position-absolute top-0 end-0 p-0 px-1 remover-pdf" style="${display_pdf}" data-vtt1_visita_tecnica_dado_id="${dado.id}" data-vtt1_slot="${i}"><i class="fas fa-times"></i></button>
                    `;
                }
