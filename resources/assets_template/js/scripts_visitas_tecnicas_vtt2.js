...
function vtt2_formControle(op) {
    ...
    let finalizar = document.getElementById('vtt2_divFinaçizar');
...
async function vtt2_visitaTecnicaGerarPdf(visita_tecnica_id=0, traducao='pt', vt_cs=1) {
    try {
        ...
        await vtt2_gerarPDF(visita_tecnica_id, traducao, vt_cs);
    } catch (e) {
...
async function vtt2_gerarPDF(visita_tecnica_id=0, traducao='pt', vt_cs) {
