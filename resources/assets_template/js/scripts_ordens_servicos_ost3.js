...
//     function inserirTexto({x_texto = '', x_spacingBetweenTexts = spacingBetweenTexts3, x_marginLeft = marginLeft, x_marginTop = novaMarginTop, x_font = 1, x_fontStyle = 'normal', x_fontSize = 12, x_align = 'left', x_subtitulo = ''}) {
...
//         inserirTexto({ x_texto: texto, x_spacingBetweenTexts: spacingBetweenTexts3, x_fontSize: 11, x_align: 'justify', x_fontStyle: 'bold' });
//
...
//         if (traducao == 'en') {texto = await traduzirTextoGoogle(texto);}
//         inserirTexto({x_texto:texto, x_spacingBetweenTexts:spacingBetweenTexts2, x_marginLeft:marginLeft, x_marginTop:marginTop, x_fontSize:12, x_align:'right'});
//
//         //Texto
//         texto = data.success.cliente_nome;
//         if (traducao == 'en') {texto = await traduzirTextoGoogle(texto);}
//         inserirTexto({x_texto:texto, x_spacingBetweenTexts:spacingBetweenTexts2, x_fontStyle:'bold', x_fontSize:11});
//
//         //Texto
//         texto = data.success.cliente_logradouro;
//         if (traducao == 'en') {texto = await traduzirTextoGoogle(texto);}
//         inserirTexto({x_texto:texto, x_spacingBetweenTexts:spacingBetweenTexts2, x_fontSize:11});
//
//         //Texto
...
//         if (traducao == 'en') {texto = await traduzirTextoGoogle(texto);}
//         inserirTexto({x_texto:'', x_spacingBetweenTexts:spacingBetweenTexts3});
//         inserirTexto({x_texto:texto, x_spacingBetweenTexts:spacingBetweenTexts2, x_fontStyle:'bold', x_fontSize:11, x_subtitulo:'subtitulo'});
//
...
//             if (traducao == 'en') {texto = await traduzirTextoGoogle(texto);}
//             inserirTexto({x_texto:texto, x_spacingBetweenTexts:spacingBetweenTexts4, x_fontSize:11, x_align:'justify', x_fontStyle:'normal'});
//         }
//
...
//         let destinos = [];
//         ordem_servico_destinos.forEach(function (dado) {
//             if (dado.destino_cep && dado.destino_ordem > 0 && dado.destino_ordem <= 10) {
...
//                 if (traducao == 'en') {texto = await traduzirTextoGoogle(texto);}
//                 inserirTexto({ x_texto: '', x_spacingBetweenTexts: spacingBetweenTexts5 });
//                 inserirTexto({ x_texto: texto, x_spacingBetweenTexts: spacingBetweenTexts4, x_fontStyle: 'bold', x_fontSize: 11, x_subtitulo: 'subtitulo' });
//
//                 try {
//                     //Distância e Duração''''''''''''''''''''''''''''''''''''
...
//                     if (traducao == 'en') {texto = await traduzirTextoGoogle(texto);}
//                     inserirTexto({ x_texto: '       '+texto, x_spacingBetweenTexts: spacingBetweenTexts3, x_fontSize: 10, x_align: 'justify', x_fontStyle: 'normal' });
//
//                     //Texto
...
//
//                     await inserirMapa(doc, mapa, textWidth, 80);
//                     //'''''''''''''''''''''''''''''''''''''''''''''''''''''''
//                 } catch (err) {
