...
function validar_frm_upload_documentos() {
    ...
    //Campo: cex_documentos_data_emissao (não requerido / Data Válida)
    if (validacao({op:1, value:document.getElementById('cex_documentos_data_emissao').value}) === true) {
        //Campo: cex_documentos_data_emissao (Data Válida)
        if (validacao({op:8, value:document.getElementById('cex_documentos_data_emissao').value}) === false) {
            validacao_ok = false;
            mensagem += 'Data emissão Inválida.'+'<br>';
        }
    }

    //Campo: cex_documentos_data_vencimento (não requerido / Data Válida)
    if (validacao({op:1, value:document.getElementById('cex_documentos_data_vencimento').value}) === true) {
        //Campo: cex_documentos_data_vencimento (Data Válida)
        if (validacao({op:8, value:document.getElementById('cex_documentos_data_vencimento').value}) === false) {
            validacao_ok = false;
...
async function clienteExecutivoModalInfoDados(id='') {
    ...
    fetch(url_atual+'clientes_executivos/modalInfo/modal_info/'+id, {
        ...
        if (document.getElementById('mi_cex_fotografia_documento')) { document.getElementById('mi_cex_fotografia_documento').src = fotografia_documento; }
        ...
        if (document.getElementById('mi_cex_fotografia_cartao_emergencial')) { document.getElementById('mi_cex_fotografia_cartao_emergencial').src = fotografia_cartao_emergencial; }
...
function clienteExecutivoModalInfoDocumentos(cliente_executivo_id = '') {
    if (cliente_executivo_id == '') { cliente_executivo_id = document.getElementById('mi_cex_cliente_executivo_id').value; }
    ...
    if (confirmed) {
        ...
        fetch(url_atual+'clientes_executivos/modalInfo/deletar_documento/'+cliente_executivo_documento_id, {
            ...
            if (data.success) {
                ...
                //Dados
                let cliente_executivo_id = document.getElementById('mi_cex_cliente_executivo_id').value;
...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    const frm_upload_documentos_cex_executar = document.getElementById('frm_upload_documentos_cex_executar');

    if (frm_upload_documentos_cex_executar) {
        frm_upload_documentos_cex_executar.addEventListener('click', function () {
            //FormData
            ...
            //Tratar Botões
            frm_upload_documentos_cex_executar.style.display = 'block';
    ...
    const frm_upload_fotografia_documento_cex_executar = document.getElementById('frm_upload_fotografia_documento_cex_executar');

    if (frm_upload_fotografia_documento_cex_executar) {
        frm_upload_fotografia_documento_cex_executar.addEventListener('click', function () {
            //FormData
            ...
            //Tratar Botões
            frm_upload_fotografia_documento_cex_executar.style.display = 'block';
    ...
    const frm_upload_fotografia_cartao_emergencial_cex_executar = document.getElementById('frm_upload_fotografia_cartao_emergencial_cex_executar');

    if (frm_upload_fotografia_cartao_emergencial_cex_executar) {
        frm_upload_fotografia_cartao_emergencial_cex_executar.addEventListener('click', function () {
            //FormData
            ...
            //Tratar Botões
            frm_upload_fotografia_cartao_emergencial_cex_executar.style.display = 'block';
