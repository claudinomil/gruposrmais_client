...
(function () {
    ...
    var getTransition = function (comp, transConfig, transState) {
      var route = getCurrentPageRoute(comp, transConfig);
    ...
    var getCurrentPageRoute = function (comp, transConfig, _transState) {
      var el = comp.element;
    ...
    var events$1 = function (transConfig, transState) {
      return derive$3([
        run(transitionend(), function (component, simulatedEvent) {
          ...
          getCurrentPageRoute(component, transConfig).each(function (route) {
