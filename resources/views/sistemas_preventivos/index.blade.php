...
@section('title') Sistemas Preventivo @endsection

@section('topbar_title')
{{ __('Sistemas Preventivo') }}
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 float-end">
                                    ...
                                    @php
                                        ...
                                        ['value' => 'sistemas_preventivos.name', 'descricao' => __('Nome')]
                                        ];
                                    @endphp
                    ...
                    <x-table-crud-ajax :numCols="5" :colsNames="[__('Medida Segurança'), __('Nome'), __('Ações')]" />
                    ...
                    <input type="hidden" id="crudFieldsColumnsTable" name="crudFieldsColumnsTable" value="medidaSegurancaName,name,action">
                </div>
            </div>
        </div>
    </div>
...
<!-- Modal -->
@include('sistemas_preventivos.form')
@endsection

@section('script')
    <!-- scripts_sistemas_preventivos.js -->
    <script src="{{ Vite::asset('resources/assets_template/js/scripts_sistemas_preventivos.js')}}"></script>
@endsection
