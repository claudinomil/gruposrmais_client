                            ...
                            <div class="row mt-4">
                                <div class="row pt-4">
                                    ...
                                    <div class="row alert alert-success p-1 m-1">
                                        ...
                                        <div class="form-group col-12 col-md-4 pb-3">
                                            ...
                                            <div class="" id="divMaterialName"></div>
                                        </div>
                                        <div class="form-group col-12 col-md-4 pb-3">
                                ...
                                <div class="row pt-4" id="divAlterarSituacaoLocal">
                                    ...
                                    <div class="form-group col-12 col-md-3 pb-3">
                                        ...
                                        <select class="form-control" name="atual_material_situacao_id" id="atual_material_situacao_id">
                                            <option value="">{{ __('Selecione...') }}</option>

                                            @foreach ($material_situacoes as $situacao)
