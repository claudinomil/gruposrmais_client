...
@section('title') Brigadas Incêndios @endsection

@section('topbar_title')
{{ __('Brigadas Incêndios') }}
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <x-table-crud-ajax :numCols="3" :colsNames="[__('Brigada Incêndio'), __('Cliente'), __('Ações')]" />
                    ...
                    <input type="hidden" id="crudFieldsColumnsTable" name="crudFieldsColumnsTable" value="brigada_incendio,clienteName,action">
                </div>
            </div>
        </div>
    </div>
...
<!-- Modal -->
@include('brigadas_incendios.form')
@endsection

@section('script')
    <!-- scripts_brigadas_incendios.js -->
    <script src="{{ Vite::asset('resources/assets_template/js/scripts_brigadas_incendios.js')}}"></script>
@endsection
