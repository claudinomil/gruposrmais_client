                        ...
                        <fieldset>
                            ...
                            <div class="row pt-4">
                                ...
                                <div class="form-group col-12 col-md-8 pb-3">
                                    <label class="form-label">{{ __('Edificação Nível') }}</label>
                                    <select class="form-select" name="edificacao_nivel_id" id="edificacao_nivel_id">
                                        <option value="">{{ __('Selecione...') }}</option>

                                        @foreach ($edificacoes_niveis as $edificacao_nivel)
                                        <option value="{{ $edificacao_nivel['id'] }}">{{ $edificacao_nivel['name'] . ' - ' . $edificacao_nivel['edificacaoName'] . ' - ' . $edificacao_nivel['clienteName'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
