                ...
                <div class="card-body">
                    ...
                    <form id="{{$se_nameFormSubmodulo}}" name="{{$se_nameFormSubmodulo}}">
                        <fieldset>
                            ...
                            <!-- ORDEM DE SERVIÇO TIPO 4 - INÍCIO------------------------------------------------------>
                            <!-- ORDEM DE SERVIÇO TIPO 4 - INÍCIO------------------------------------------------------>
                            <div class="row mt-4" id="divOST4">
                                <div class="row pt-4" id="ost4_divOrdemServicoInformacoesGerais">
                                    <h5 class="pb-4 text-primary"><i class="fas fa-list"></i>{{ __(' Informações Gerais') }}</h5>
                                    <div class="form-group col-12 col-md-2 pb-3">
                                        <label class="form-label">Status</label>
                                        <select class="form-select" name="ost4_ordem_servico_status_id" id="ost4_ordem_servico_status_id">
                                            @foreach ($ordem_servico_status as $registro)
                                                <option value="{{ $registro['id'] }}">{{ $registro['name'] }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-12 col-md-1 pb-3">
                                        <label class="form-label">{{ __('Número') }}</label>
                                        <input type="text" class="form-control" id="ost4_numero_ordem_servico" name="ost4_numero_ordem_servico" readonly>
                                    </div>
                                    <div class="form-group col-12 col-md-1 pb-3">
                                        <label class="form-label">Ano</label>
                                        <input type="text" class="form-control" id="ost4_ano_ordem_servico" name="ost4_ano_ordem_servico" readonly>
                                    </div>
                                    <div class="form-group col-12 col-md-2 pb-3">
                                        <label class="form-label">Data abertura</label>
                                        <input type="text" class="form-control mask_date" id="ost4_data_abertura" name="ost4_data_abertura" readonly>
                                    </div>
                                    <div class="form-group col-12 col-md-2 pb-3">
                                        <label class="form-label">Hora abertura</label>
                                        <input type="text" class="form-control mask_time" id="ost4_hora_abertura" name="ost4_hora_abertura" readonly>
                                    </div>
                                    <div class="form-group col-12 col-md-2 pb-3">
                                        <label class="form-label">Data prevista</label>
                                        <input type="text" class="form-control mask_date" id="ost4_data_prevista" name="ost4_data_prevista">
                                    </div>
                                    <div class="form-group col-12 col-md-2 pb-3">
                                        <label class="form-label">Hora prevista</label>
                                        <input type="text" class="form-control mask_time" id="ost4_hora_prevista" name="ost4_hora_prevista">
                                    </div>
                                    <div class="form-group col-12 col-md-2 pb-3">
                                        <label class="form-label">Data conclusão</label>
                                        <input type="text" class="form-control mask_date" id="ost4_data_conclusao" name="ost4_data_conclusao">
                                    </div>
                                    <div class="form-group col-12 col-md-2 pb-3">
                                        <label class="form-label">Hora conclusão</label>
                                        <input type="text" class="form-control mask_time" id="ost4_hora_conclusao" name="ost4_hora_conclusao">
                                    </div>
                                    <div class="form-group col-12 col-md-2 pb-3">
                                        <label class="form-label">Data finalização</label>
                                        <input type="text" class="form-control mask_date" id="ost4_data_finalizacao" name="ost4_data_finalizacao">
                                    </div>
                                    <div class="form-group col-12 col-md-2 pb-3">
                                        <label class="form-label">Hora finalização</label>
                                        <input type="text" class="form-control mask_time" id="ost4_hora_finalizacao" name="ost4_hora_finalizacao">
                                    </div>
                                </div>

                                <!-- Cliente -->
                                <!-- Cliente -->
                                <div class="row pt-4" id="ost4_divClientes">
                                    <h5 class="pb-4 text-primary"><i class="fas fa-table"></i> Cliente</h5>
                                    <div class="form-group col-12 col-md-4 pb-3">
                                        <label class="form-label">Cliente</label>
                                        <select class="form-select" name="ost4_cliente_id" id="ost4_cliente_id" required="required">
                                            <option value="">{{ __('Selecione...') }}</option>
                                    ...
                                    <div class="form-group col-12 col-md-4 pb-3">
                                        <label class="form-label">{{ __('Nome') }}</label>
                                        <input type="text" class="form-control text-uppercase" id="ost4_cliente_nome" name="ost4_cliente_nome" readonly>
                                    </div>
                                    <div class="form-group col-12 col-md-2 pb-3">
                                        <label class="form-label">{{ __('Telefone') }}</label>
                                        <input type="text" class="form-control mask_phone_with_ddd" id="ost4_cliente_telefone" name="ost4_cliente_telefone" readonly>
                                    </div>
                                    <div class="form-group col-12 col-md-2 pb-3">
                                        <label class="form-label">{{ __('Celular') }}</label>
                                        <input type="text" class="form-control mask_cell_with_ddd" id="ost4_cliente_celular" name="ost4_cliente_celular" readonly>
                                    </div>
                                    <div class="form-group col-12 col-md-4 pb-3">
                                        <label class="form-label">{{ __('E-mail') }}</label>
                                        <input type="email" class="form-control text-lowercase" id="ost4_cliente_email" name="ost4_cliente_email" readonly>
                                    </div>
                                    <div class="form-group col-12 col-md-4 pb-3">
                                        <label class="form-label">{{ __('Logradouro') }}</label>
                                        <input type="text" class="form-control text-uppercase" id="ost4_cliente_logradouro" name="ost4_cliente_logradouro" readonly>
                                    </div>
                                    <div class="form-group col-12 col-md-4 pb-3">
                                        <label class="form-label">{{ __('Bairro') }}</label>
                                        <input type="text" class="form-control text-uppercase" id="ost4_cliente_bairro" name="ost4_cliente_bairro" readonly>
                                    </div>
                                    <div class="form-group col-12 col-md-4 pb-3">
                                        <label class="form-label">Cidade</label>
                                        <input type="text" class="form-control text-uppercase" id="ost4_cliente_cidade" name="ost4_cliente_cidade" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row pt-4">
                                    ...
                                    <div class="form-group col-12 col-md-6 pb-3">
                                        <label class="form-label">Serviço</label>
                                        <input type="text" class="form-control text-uppercase" id="ost4_ts_servico_nome" name="ost4_ts_servico_nome" readonly>
                                    </div>
                                    <div class="form-group col-12 col-md-6 pb-3">
                                        <label class="form-label">Responsável</label>
                                        <select class="form-select" name="ost4_ts_responsavel_funcionario_id" id="ost4_ts_responsavel_funcionario_id">
                                            <option value="">{{ __('Selecione...') }}</option>
                                    ...
                                    <!-- Campos hiddens para salvar na tabela ordens_servicos_servicos -->
                                    <div id="ost4_ts_servico_hiddens"></div>

                                    <div class="form-group col-12 col-md-12 pt-3 pb-3">
                                        <label class="form-label">Descrição serviço</label>
                                        <textarea class="form-control" id="ost4_descricao_servico" name="ost4_descricao_servico" rows="3"></textarea>
                                    </div>
                                    <div class="form-group col-12 col-md-12 pb-3">
                                        <label class="form-label">Observação</label>
                                        <textarea class="form-control" id="ost4_observacao" name="ost4_observacao" rows="3"></textarea>
                                    </div>
                                    <div class="form-group col-12 col-md-4 pb-3">
                                        <label class="form-label">Prioridade</label>
                                        <select class="form-select" name="ost4_ordem_servico_prioridade_id" id="ost4_ordem_servico_prioridade_id" required="required">
                                            @foreach ($ordem_servico_prioridades as $ordem_servico_prioridade)
                                                <option value="{{ $ordem_servico_prioridade['id'] }}">{{ $ordem_servico_prioridade['name'] }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row pt-4">
                                    <h5 class="pb-4 text-primary"><i class="fas fa-table"></i> Destinos</h5>
                                    <div class="row col-12" id="ost4_te_divDestinoEscolher">
                                        <div class="form-group col-12 col-md-2 pb-3">
                                            <label class="form-label">Destino (Ordem)</label>
                                            <select class="form-select" name="ost4_te_destino_ordem" id="ost4_te_destino_ordem">
                                                <option value="">{{ __('Selecione...') }}</option>
                                                <option value="1">1</option>
                                                <option value="2">2</option>
                                                <option value="3">3</option>
                                            ...
                                            <input type="hidden" id="ost4_te_destino_logradouro" name="ost4_te_destino_logradouro">
                                            <input type="hidden" id="ost4_te_destino_bairro" name="ost4_te_destino_bairro">
                                            <input type="hidden" id="ost4_te_destino_localidade" name="ost4_te_destino_localidade">
                                            <input type="hidden" id="ost4_te_destino_uf" name="ost4_te_destino_uf">
                                        </div>
                                        <div class="form-group col-12 col-md-3 pb-3">
                                            <label class="form-label">Destino (CEP)</label>
                                            <input type="text" class="form-control mask_cep" id="ost4_te_destino_cep" name="ost4_te_destino_cep">
                                        </div>
                                        <div class="form-group col-12 col-md-2 pb-3">
                                            <label class="form-label">Destino (Número)</label>
                                            <input type="text" class="form-control" id="ost4_te_destino_numero" name="ost4_te_destino_numero">
                                        </div>
                                        <div class="form-group col-12 col-md-3 pb-3">
                                            <label class="form-label">Destino (Complemento)</label>
                                            <input type="text" class="form-control" id="ost4_te_destino_complemento" name="ost4_te_destino_complemento">
                                        </div>
                                        <div class="form-group col-12 col-md-2 pb-3">
                                            <label class="form-label">Opções</label>
                                            <div class="row">
                                                <div class="col-6" id="ost4_te_divDestinoAdicionar" style="display: none;">
                                                    <x-button-crud op="99" model="1" bgColor="success" textColor="write" id="ost4_te_destino_adicionar" name="ost4_te_destino_adicionar" title="Adicionar Destino na Grade" image="fas fa-check" />
                                                </div>
                                                <div class="col-6" id="ost4_te_divDestinoRetirar" style="display: none;">
                                                    <x-button-crud op="99" model="1" bgColor="danger" textColor="write" id="ost4_te_destino_retirar" name="ost4_te_destino_retirar" title="Retirar Destino da Grade" image="fas fa-trash-alt" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <tbody id="ost4_te_destino_grade"></tbody>
                                        </table>
                                    </div>

                                    <!-- Campos hiddens para salvar na tabela ordens_servicos_destinos -->
                                    <div id="ost4_te_destino_hiddens"></div>
                                </div>
                                ...
                                <div class="row pt-4">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <tbody id="ost4_te_destino_datas_horas_grade"></tbody>
                                        </table>
                                    </div>
                                </div>
                                ...
                                <div class="row pt-4">
                                    <h5 class="pb-4 text-primary"><i class="fas fa-table"></i> Veículos</h5>
                                    <div class="row col-12" id="ost4_te_divVeiculoEscolher">
                                        <div class="form-group col-12 col-md-10 pb-3">
                                            <label class="form-label">Veículo</label>
                                            <select class="form-select" name="ost4_te_veiculo_id" id="ost4_te_veiculo_id">
                                                <option value="">{{ __('Selecione...') }}</option>
                                            ...
                                            <input type="hidden" id="ost4_te_veiculo_marca" name="ost4_te_veiculo_marca">
                                            <input type="hidden" id="ost4_te_veiculo_modelo" name="ost4_te_veiculo_modelo">
                                            <input type="hidden" id="ost4_te_veiculo_placa" name="ost4_te_veiculo_placa">
                                            <input type="hidden" id="ost4_te_veiculo_combustivel" name="ost4_te_veiculo_combustivel">
                                        </div>
                                        <div class="form-group col-12 col-md-2 pb-3">
                                            <label class="form-label">Opções</label>
                                            <div class="row">
                                                <div class="col-6" id="ost4_te_divVeiculoAdicionar" style="display: none;">
                                                    <x-button-crud op="99" model="1" bgColor="success" textColor="write" id="ost4_te_veiculo_adicionar" name="ost4_te_veiculo_adicionar" title="Adicionar Veículo na Grade" image="fas fa-check" />
                                                </div>
                                                <div class="col-6" id="ost4_te_divVeiculoRetirar" style="display: none;">
                                                    <x-button-crud op="99" model="1" bgColor="danger" textColor="write" id="ost4_te_veiculo_retirar" name="ost4_te_veiculo_retirar" title="Retirar Veículo da Grade" image="fas fa-trash-alt" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <tbody id="ost4_te_veiculo_grade"></tbody>
                                        </table>
                                    </div>

                                    <!-- Campos hiddens para salvar na tabela ordens_servicos_veiculos -->
                                    <div id="ost4_te_veiculo_hiddens"></div>
                                </div>

                                <!-- Funcionários -->
                                <!-- Funcionários -->
                                <div class="row pt-4">
                                    <h5 class="pb-4 text-primary"><i class="fas fa-table"></i> Funcionários</h5>
                                    <div class="row col-12" id="ost4_te_divFuncionarioEscolher">
                                        <div class="form-group col-12 col-md-6 pb-3">
                                            <label class="form-label">Funcionário</label>
                                            <select class="form-select" name="ost4_te_funcionario_id" id="ost4_te_funcionario_id">
                                                <option value="">{{ __('Selecione...') }}</option>
                                            ...
                                            <input type="hidden" id="ost4_te_funcionario_nome" name="ost4_te_funcionario_nome">
                                        </div>
                                        <div class="form-group col-12 col-md-4 pb-3">
                                            <label class="form-label">Veículo</label>
                                            <select class="form-select" name="ost4_te_funcionario_veiculo_id" id="ost4_te_funcionario_veiculo_id">
                                                <option value="">{{ __('Selecione...') }}</option>
                                            </select>
                                        </div>
                                        <div class="form-group col-12 col-md-2 pb-3">
                                            <label class="form-label">Opções</label>
                                            <div class="row">
                                                <div class="col-6" id="ost4_te_divFuncionarioAdicionar" style="display: none;">
                                                    <x-button-crud op="99" model="1" bgColor="success" textColor="write" id="ost4_te_funcionario_adicionar" name="ost4_te_funcionario_adicionar" title="Adicionar Funcionário na Grade" image="fas fa-check" />
                                                </div>
                                                <div class="col-6" id="ost4_te_divFuncionarioRetirar" style="display: none;">
                                                    <x-button-crud op="99" model="1" bgColor="danger" textColor="write" id="ost4_te_funcionario_retirar" name="ost4_te_funcionario_retirar" title="Retirar Funcionário da Grade" image="fas fa-trash-alt" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <tbody id="ost4_te_funcionario_grade"></tbody>
                                        </table>
                                    </div>

                                    <!-- Campos hiddens para salvar na tabela ordens_servicos_funcionarios -->
                                    <div id="ost4_te_funcionario_hiddens"></div>
                                </div>
                                ...
                                <div class="row pt-4">
                                    <h5 class="pb-4 text-primary"><i class="fas fa-table"></i> Equipes</h5>
                                    <div class="row col-12" id="ost4_te_divEquipeEscolher">
                                        <div class="form-group col-12 col-md-6 pb-3">
                                            <label class="form-label">Funcionário</label>
                                            <select class="form-select" name="ost4_te_equipe_funcionario_id" id="ost4_te_equipe_funcionario_id">
                                                <option value="">{{ __('Selecione...') }}</option>
                                            ...
                                            <input type="hidden" id="ost4_te_equipe_funcionario_nome" name="ost4_te_equipe_funcionario_nome">
                                            <input type="hidden" id="ost4_te_equipe_funcionario_funcao" name="ost4_te_equipe_funcionario_funcao">
                                        </div>
                                        <div class="form-group col-12 col-md-4 pb-3">
                                            <label class="form-label">Veículo</label>
                                            <select class="form-select" name="ost4_te_equipe_funcionario_veiculo_id" id="ost4_te_equipe_funcionario_veiculo_id">
                                                <option value="">{{ __('Selecione...') }}</option>
                                            </select>
                                        </div>
                                        <div class="form-group col-12 col-md-2 pb-3">
                                            <label class="form-label">Opções</label>
                                            <div class="row">
                                                <div class="col-6" id="ost4_te_divEquipeAdicionar" style="display: none;">
                                                    <x-button-crud op="99" model="1" bgColor="success" textColor="write" id="ost4_te_equipe_funcionario_adicionar" name="ost4_te_equipe_funcionario_adicionar" title="Adicionar Funcionário na Grade" image="fas fa-check" />
                                                </div>
                                                <div class="col-6" id="ost4_te_divEquipeRetirar" style="display: none;">
                                                    <x-button-crud op="99" model="1" bgColor="danger" textColor="write" id="ost4_te_equipe_funcionario_retirar" name="ost4_te_equipe_funcionario_retirar" title="Retirar Funcionário da Grade" image="fas fa-trash-alt" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <tbody id="ost4_te_equipe_funcionario_grade"></tbody>
                                        </table>
                                    </div>

                                    <!-- Campos hiddens para salvar na tabela ordens_servicos_equipes -->
                                    <div id="ost4_te_equipe_funcionario_hiddens"></div>
                                </div>
                            </div>
                            <!-- ORDEM DE SERVIÇO TIPO 4 - FIM--------------------------------------------------------->
                            <!-- ORDEM DE SERVIÇO TIPO 4 - FIM--------------------------------------------------------->
                        </fieldset>
                    </form>
