        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 float-end">
                                    ...
                                    @php
                                        ...
                                        ['value' => 'grupos.name', 'descricao' => __('Nome')]
                                        ];
                                    @endphp
                    ...
                    <x-table-crud-ajax :numCols="3" :colsNames="[__('Nome'), __('Permissões'), __('Ações')]" />
                    ...
                    <input type="hidden" id="crudFieldsColumnsTable" name="crudFieldsColumnsTable" value="name,permissoes,action">
                </div>
            </div>
        </div>
    </div>
