...
{{--@vite(['resources/assets_template/libs/jquery/jquery.min.js'])--}}
{{--@vite(['resources/assets_template/libs/bootstrap/bootstrap.min.js'])--}}
{{--@vite(['resources/assets_template/libs/jquery-validation/jquery-validation.min.js'])--}}
{{--@vite(['resources/assets_template/libs/jquery-validation/jquery-validation-pt-br.js'])--}}
{{--@vite(['resources/assets_template/js/jquery-validation-methods.js'])--}}
{{--@vite(['resources/assets_template/libs/metismenu/metismenu.min.js'])--}}
{{--@vite(['resources/assets_template/libs/simplebar/simplebar.min.js'])--}}
{{--@vite(['resources/assets_template/libs/node-waves/node-waves.min.js'])--}}
{{--@vite(['resources/assets_template/libs/sweetalert2/sweetalert2.min.js'])--}}
{{--@vite(['resources/assets_template/libs/select2/select2.min.js'])--}}
{{--@vite(['resources/assets_template/libs/datatables/datatables.min.js'])--}}
{{--@vite(['resources/assets_template/libs/jquery-repeater/jquery-repeater.js'])--}}
{{--@vite(['resources/assets_template/libs/jszip/jszip.min.js'])--}}
{{--@vite(['resources/assets_template/libs/pdfmake/pdfmake.min.js'])--}}
{{--@vite(['resources/assets_template/libs/jquery-mask/jquery.mask.min.js'])--}}
{{--@vite(['resources/assets_template/js/jquery-masks.js'])--}}
{{--@vite(['resources/assets_template/js/app.min.js'])--}}
{{--@vite(['resources/assets_template/js/main.js'])--}}
...
<!-- cruds_functions.js -->
<script type="text/javascript" src="{{ Vite::asset('resources/assets_template/js/cruds_functions.js') }}"></script>

<!-- cruds.js -->
<script type="text/javascript" src="{{ Vite::asset('resources/assets_template/js/cruds.js') }}"></script>
