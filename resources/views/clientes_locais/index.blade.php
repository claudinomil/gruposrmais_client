...
@section('title') Clientes Locais @endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 float-end">
                                    ...
                                    <input type="hidden" id="filter-crud-filter_crud_campo_pesquisar" value="clientes_locais.name">
                                    <input type="hidden" id="filter-crud-filter_crud_operacao_realizar" value="1">

                                    @php
                                        $selectCampoPesquisar = [
                                        ['value' => 'clientes_locais.name', 'descricao' => __('Nome')]
                                        ];
                                    @endphp
                    ...
                    <x-table-crud-ajax :numCols="4" :colsNames="[__('Cliente'), __('Nome'), __('Descrição'), __('Ações')]" />
                    ...
                    <input type="hidden" id="crudFieldsColumnsTable" name="crudFieldsColumnsTable" value="clienteName,name,descricao,action">
                </div>
            </div>
        </div>
    </div>
...
<!-- Modal -->
@include('clientes_locais.form')
@endsection

@section('script')
    <!-- scripts_clientes_locais.js -->
    <script src="{{ Vite::asset('resources/assets_template/js/scripts_clientes_locais.js')}}"></script>
@endsection
