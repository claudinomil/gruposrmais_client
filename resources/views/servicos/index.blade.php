        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 float-end">
                                    ...
                                    @php
                                        ...
                                        ['value' => 'servicos.name', 'descricao' => __('Nome')],
                                        ['value' => 'servico_tipos.name', 'descricao' => __('Serviço Tipo')]
                                        ];
                                    @endphp
                    ...
                    <x-table-crud-ajax :numCols="3" :colsNames="[__('Nome'), __('Serviço Tipo'), __('Ações')]" />
                    ...
                    <input type="hidden" id="crudFieldsColumnsTable" name="crudFieldsColumnsTable" value="name,servicoTipoName,action">
                </div>
            </div>
        </div>
    </div>
