...
@section('title') Materiais @endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 float-end">
                                    ...
                                    @php
                                        ...
                                        ['value' => 'materiais.name', 'descricao' => 'Nome']
                                        ];
                                    @endphp
                    ...
                    <x-table-crud-ajax :numCols="3" :colsNames="['Nome', 'Categoria', 'Ações']" />
...
<!-- Modal -->
@include('materiais.form')
@endsection

@section('script')
    <!-- scripts_materiais.js -->
    <script src="{{ Vite::asset('resources/assets_template/js/scripts_materiais.js')}}"></script>
@endsection
