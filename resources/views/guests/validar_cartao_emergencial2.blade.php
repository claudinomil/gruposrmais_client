...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        $doenca_diabetes_checked = ($content['doenca_diabetes'] == 1) ? '<i class="fa fa-check" style="color: #28a745;"></i>' : '<i class="fa fa-times" style="color: #a92222;"></i>';
        $doenca_hipertensao_checked = ($content['doenca_hipertensao'] == 1) ? '<i class="fa fa-check" style="color: #28a745;"></i>' : '<i class="fa fa-times" style="color: #a92222;"></i>';
        $doenca_asma_checked = ($content['doenca_asma'] == 1) ? '<i class="fa fa-check" style="color: #28a745;"></i>' : '<i class="fa fa-times" style="color: #a92222;"></i>';
        $doenca_renal_checked = ($content['doenca_renal'] == 1) ? '<i class="fa fa-check" style="color: #28a745;"></i>' : '<i class="fa fa-times" style="color: #a92222;"></i>';
        $doenca_cardiaca_checked = ($content['doenca_cardiaca'] == 1) ? '<i class="fa fa-check" style="color: #28a745;"></i>' : '<i class="fa fa-times" style="color: #a92222;"></i>';
        $doenca_outras_checked = ($content['doenca_outras'] != '') ? '<i class="fa fa-check" style="color: #28a745;"></i>' : '<i class="fa fa-times" style="color: #a92222;"></i>';
        ...
        $doenca_familia_diabetes_checked = ($content['doenca_familia_diabetes'] == 1) ? '<i class="fa fa-check" style="color: #28a745;"></i>' : '<i class="fa fa-times" style="color: #a92222;"></i>';
        $doenca_familia_hipertensao_checked = ($content['doenca_familia_hipertensao'] == 1) ? '<i class="fa fa-check" style="color: #28a745;"></i>' : '<i class="fa fa-times" style="color: #a92222;"></i>';
        $doenca_familia_epilepsia_checked = ($content['doenca_familia_epilepsia'] == 1) ? '<i class="fa fa-check" style="color: #28a745;"></i>' : '<i class="fa fa-times" style="color: #a92222;"></i>';
        $doenca_familia_cardiaca_checked = ($content['doenca_familia_cardiaca'] == 1) ? '<i class="fa fa-check" style="color: #28a745;"></i>' : '<i class="fa fa-times" style="color: #a92222;"></i>';
        $doenca_familia_cancer_checked = ($content['doenca_familia_cancer'] == 1) ? '<i class="fa fa-check" style="color: #28a745;"></i>' : '<i class="fa fa-times" style="color: #a92222;"></i>';
        $doenca_familia_outras_checked = ($content['doenca_familia_outras'] != '') ? '<i class="fa fa-check" style="color: #28a745;"></i>' : '<i class="fa fa-times" style="color: #a92222;"></i>';
        $doenca_familia_outras = $content['doenca_familia_outras'];

        //Contato Principal e Alternativo'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
        ...
        <div class="section">
            ...
            <div class="checkbox-group">
                <label>{!! $doenca_diabetes_checked !!} Diabetes</label>
                <label>{!! $doenca_hipertensao_checked !!} Hipertensão</label>
                <label>{!! $doenca_asma_checked !!} Asma</label>
                <label>{!! $doenca_renal_checked !!} Doença renal</label>
                <label>{!! $doenca_cardiaca_checked !!} Doença cardíaca</label>
                <label>{!! $doenca_outras_checked !!} Outra(s): <input type="text" value="{{ $doenca_outras }}" disabled></label>
            </div>
        ...
        <div class="section">
            ...
            <div class="checkbox-group">
                <label>{!! $doenca_familia_cardiaca_checked !!} Doença cardíaca</label>
                <label>{!! $doenca_familia_diabetes_checked !!} Diabetes</label>
                <label>{!! $doenca_familia_hipertensao_checked !!} Hipertensão</label>
                <label>{!! $doenca_familia_epilepsia_checked !!} Epilepsia</label>
                <label>{!! $doenca_familia_cancer_checked !!} Câncer</label>
                <label>{!! $doenca_familia_outras_checked !!} Outras: <input type="text" value="{{ $doenca_familia_outras }}" disabled></label>
            </div>
        </div>
