...
@section('title') Medidas Segurança @endsection

@section('topbar_title')
{{ __('Medidas Segurança') }}
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 float-end">
                                    ...
                                    <input type="hidden" id="filter-crud-filter_crud_campo_pesquisar" value="medidas_seguranca.name">
                                    <input type="hidden" id="filter-crud-filter_crud_operacao_realizar" value="1">

                                    @php
                                        $selectCampoPesquisar = [
                                        ['value' => 'medidas_seguranca.name', 'descricao' => __('Nome')]
                                        ];
                                    @endphp
                    ...
                    <x-table-crud-ajax :numCols="3" :colsNames="[__('Nome'), __('Ordem'), __('Ações')]" />
                    ...
                    <input type="hidden" id="crudFieldsColumnsTable" name="crudFieldsColumnsTable" value="name,ordem,action">
                </div>
            </div>
        </div>
    </div>
...
<!-- Modal -->
@include('medidas_seguranca.form')
@endsection

@section('script')
    <!-- scripts_medidas_seguranca.js -->
    <script src="{{ Vite::asset('resources/assets_template/js/scripts_medidas_seguranca.js')}}"></script>
@endsection
