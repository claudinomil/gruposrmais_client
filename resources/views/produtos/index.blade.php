        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 float-end">
                                    ...
                                    @php
                                        ...
                                        ['value' => 'produtos.name', 'descricao' => __('Nome')]
                                        ];
                                    @endphp
                    ...
                    <input type="hidden" id="crudFieldsColumnsTable" name="crudFieldsColumnsTable" value="fotografia,name,produtoCategoriaName,action">
                </div>
            </div>
        </div>
    </div>
...
@section('script')
    <!-- scripts_produtos.js -->
    <script src="{{ Vite::asset('resources/assets_template/js/scripts_produtos.js')}}"></script>
@endsection
