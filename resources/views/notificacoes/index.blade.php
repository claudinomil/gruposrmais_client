        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <x-table-crud-ajax :numCols="4" :colsNames="['Data/Hora', 'Título', 'Notificação', 'Ações']" />
                    ...
                    <input type="hidden" id="crudFieldsColumnsTable" name="crudFieldsColumnsTable" value="date,title,notificacao,action">
                </div>
            </div>
        </div>
    </div>
