...
@section('title') Produtos Entradas @endsection

@section('topbar_title')
{{ __('Produtos Entradas') }}
@endsection
...
<!-- Modal -->
@include('produtos_entradas.form')
@endsection

@section('script')
    <!-- scripts_produtos_entradas.js -->
    <script src="{{ Vite::asset('resources/assets_template/js/scripts_produtos_entradas.js')}}"></script>
@endsection
