        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 float-end">
                                    ...
                                    @php
                                        ...
                                        ['value' => 'clientes.name', 'descricao' => __('Cliente')]
                                        ];
                                    @endphp
                    ...
                    <x-table-crud-ajax :numCols="5" :colsNames="[__('Cliente'), __('Nome'), __('Edificação'), __('Ações')]" />
                    ...
                    <input type="hidden" id="crudFieldsColumnsTable" name="crudFieldsColumnsTable" value="clienteName,name,edificacao,action">
                </div>
            </div>
        </div>
    </div>
...
<!-- Modal -->
@include('edificacoes.form')
@endsection

@section('script')
    <!-- scripts_edificacoes.js -->
    <script src="{{ Vite::asset('resources/assets_template/js/scripts_edificacoes.js')}}"></script>
@endsection
