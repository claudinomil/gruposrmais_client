...
<!-- Visualizar Mapa 1 -->
<div id="visualizar_mapa_1" style="display: none;">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="modal-buttons d-flex align-items-center gap-2" id="visualizar_mapa_1_botoes">
                        @if(\App\Facades\Permissoes::permissao(['edit']))
                            <!-- Dropdown -->
                            <div class="dropdown">
                                <a href="#" class="btn btn-outline-warning dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">Pontos Tipos <i class="mdi mdi-chevron-down"></i></a>
                                <div class="dropdown-menu p-2">
                                    @foreach ($mapas_pontos_tipos as $mapa_ponto_tipo)
                                        <div class="form-check mb-1">
                                            <input class="form-check-input checkPontoTipo" type="checkbox" id="{{ $mapa_ponto_tipo['name'] }}" value="{{ $mapa_ponto_tipo['id'] }}" checked>
                        ...
                        <!-- Botão Cancelar -->
                        <button type="button" class="btn btn-secondary text-white waves-effect btn-label waves-light" data-bs-toggle="tooltip" data-bs-placement="top" title="Cancelar Operação" id="visualizar_mapa_1_cancelar">
