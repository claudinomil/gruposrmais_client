        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <x-table-crud-ajax :numCols="3" :colsNames="[__('Proposta'), __('Cliente'), __('Ações')]" />
                    ...
                    <input type="hidden" id="crudFieldsColumnsTable" name="crudFieldsColumnsTable" value="numero_proposta,clienteName,action">
                </div>
            </div>
        </div>
    </div>
