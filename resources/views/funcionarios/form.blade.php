                            ...
                            <div class="row pt-4">
                                ...
                                <div class="form-group col-12 col-md-4 pb-3">
                                    ...
                                    <select class="form-control select2" name="funcionario_acao_1_local" id="funcionario_acao_1_local">
                                        <option value="">Selecione...</option>
                                        <option value="Sambrodomo">Sambrodomo</option>
                                ...
                                <div class="form-group col-12 col-md-4 pb-3">
                                    ...
                                    <select class="form-control select2" name="funcionario_acao_1_dias_horarios" id="funcionario_acao_1_dias_horarios">
                                        <option value="">Selecione...</option>
                                ...
                                <div class="form-group col-12 col-md-4 pb-3">
                                    ...
                                    <select class="form-control select2" name="funcionario_acao_1_valor" id="funcionario_acao_1_valor">
                                        <option value="">Selecione...</option>
