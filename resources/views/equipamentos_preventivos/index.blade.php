...
@section('title') Equipamentos Preventivos  @endsection

@section('topbar_title')
{{ __('Equipamentos Preventivos') }}
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 float-end">
                                    ...
                                    <input type="hidden" id="filter-crud-filter_crud_campo_pesquisar" value="equipamentos_preventivos.name">
                                    <input type="hidden" id="filter-crud-filter_crud_operacao_realizar" value="1">

                                    @php
                                        $selectCampoPesquisar = [
                                        ['value' => 'equipamentos_preventivos.name', 'descricao' => __('Nome')]
                                        ];
                                    @endphp
                    ...
                    <x-table-crud-ajax :numCols="3" :colsNames="[__('Nome'), __('Ações')]" />
...
<!-- Modal -->
@include('equipamentos_preventivos.form')
@endsection

@section('script')
    <!-- scripts_equipamentos_preventivos.js -->
    <script src="{{ Vite::asset('resources/assets_template/js/scripts_equipamentos_preventivos.js')}}"></script>
@endsection
