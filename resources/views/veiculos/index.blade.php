        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 float-end">
                                    ...
                                    <input type="hidden" id="filter-crud-filter_crud_campo_pesquisar" value="veiculos.placa">
                                    <input type="hidden" id="filter-crud-filter_crud_operacao_realizar" value="1">

                                    @php
                                        $selectCampoPesquisar = [
                                        ['value' => 'veiculos.placa', 'descricao' => __('Placa')],
                                        ['value' => 'veiculos.renavam', 'descricao' => __('Renavam')]
                                        ];
                                    @endphp
                    ...
                    <x-table-crud-ajax :numCols="5" :colsNames="[__('Marca'), __('Modelo'), __('Placa'), __('Renavam'), __('Ações')]" />
                    ...
                    <input type="hidden" id="crudFieldsColumnsTable" name="crudFieldsColumnsTable" value="veiculoMarcaName,veiculoModeloName,placa,renavam,action">
                </div>
            </div>
        </div>
    </div>
...
@section('script')
    <!-- scripts_veiculos.js -->
    <script src="{{ Vite::asset('resources/assets_template/js/scripts_veiculos.js')}}"></script>
@endsection
