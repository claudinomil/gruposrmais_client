                        ...
                        <fieldset>
                            ...
                            <div class="row mt-4">
                                <div class="row pt-4">
                                    ...
                                    <div class="form-group col-12 col-md-4 pb-3" style="display: none;" id="divOrigemEmpresaNome">
                                    ...
                                    <div class="form-group col-12 col-md-4 pb-3" style="display: none;" id="divOrigemClienteNome">
                                ...
                                <div class="row pt-4">
                                    <h5 class="pb-4 text-primary"><i class="fas fa-archive"></i> Materiais (Movimentação)</h5>
                                    <div class="row" id="divMateriaisMovimentacao"></div>
                                </div>
                                <div class="row pt-4">
                                    ...
                                    <div class="form-group col-12 col-md-4 pb-3" style="display: none;" id="divDestinoEmpresaNome">
                                        <label class="form-label">{{ __('Empresa') }}</label>
                                        <input type="text" class="form-control text-uppercase" id="destino_empresa_nome" name="destino_empresa_nome" readonly>
                                    </div>
                                    <div class="form-group col-12 col-md-4 pb-3" style="display: none;" id="divDestinoClienteNome">
                                        <label class="form-label">{{ __('Cliente') }}</label>
                                ...
                                <div class="row pt-4">
                                    ...
                                    <div class="form-group col-12 col-md-2 pb-3">
                                        ...
                                        <input type="text" class="form-control mask_date" id="data_movimentacao" name="data_movimentacao" readonly>
                                    </div>
