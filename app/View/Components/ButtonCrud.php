...
class ButtonCrud extends Component
{
    ...
    public function render()
    {
        ...
        if ($this->op == 1) {
            ...
            $this->class = "btn btn-success text-white mb-2 ".$modelClass." ".$this->class;
        }
        ...
        if ($this->op == 2) {
            ...
            $this->class = "btn btn-primary text-white mb-2 ".$modelClass." ".$this->class;
        }
        ...
        if ($this->op == 3) {
            ...
            $this->class = "btn btn-danger text-white mb-2 ".$modelClass." ".$this->class;
        }
        ...
        if ($this->op == 4) {
            ...
            $this->class = "btn btn-secondary text-white mb-2 ".$modelClass." ".$this->class;
        }
        ...
        if ($this->op == 7) {
            ...
            $this->class = "btn btn-warning text-white mb-2 ".$modelClass." ".$this->class;
        }
