...
class ClienteExecutivoController extends Controller
{
    ...
    {
        $this->middleware('check-permissao:clientes_executivos_list', ['only' => ['index', 'filter']]);
        $this->middleware('check-permissao:clientes_executivos_create', ['only' => ['create', 'store']]);
        $this->middleware('check-permissao:clientes_executivos_show', ['only' => ['show']]);
        $this->middleware('check-permissao:clientes_executivos_edit', ['only' => ['edit', 'update']]);
        $this->middleware('check-permissao:clientes_executivos_destroy', ['only' => ['destroy']]);
    }
