...
class Controller extends BaseController
{
    ...
    public function responseApi($op, $type, $uri, $id, $array_dados_filtro, $request)
    {
        ...
        if ($op == 2) {
            ...
            if (isset($response['content']['fornecedores'])) {$this->fornecedores = $response['content']['fornecedores'];}
            ...
            if (isset($response['content']['graficos'])) {$this->graficos = $response['content']['graficos'];}
            ...
            if (isset($response['content']['equipamentos_preventivos'])) {$this->equipamentos_preventivos = $response['content']['equipamentos_preventivos'];}
