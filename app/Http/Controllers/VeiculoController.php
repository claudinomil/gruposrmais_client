...
class VeiculoController extends Controller
{
    ...
    //Dados Auxiliares
    public $veiculo_categorias;
    public $veiculo_combustiveis;
    public $veiculo_marcas;
    public $veiculo_modelos;
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return view('veiculos.index', [
                ...
                'veiculo_combustiveis' => $this->veiculo_combustiveis,
                'veiculo_marcas' => $this->veiculo_marcas,
                'veiculo_modelos' => $this->veiculo_modelos
            ]);
        }
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($_SERVER['HTTP_REQUEST_ORIGIN'] == 'fetch') {
            ...
            $this->responseApi(1, 4, 'veiculos', '', '', $request->all());
    ...
    public function show($id)
    {
        ...
        if ($_SERVER['HTTP_REQUEST_ORIGIN'] == 'fetch') {
            ...
            $this->responseApi(1, 2, 'veiculos', $id, '', '');
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($_SERVER['HTTP_REQUEST_ORIGIN'] == 'fetch') {
            ...
            $this->responseApi(1, 5, 'veiculos', $id, '', $request->all());
    ...
    public function destroy($id)
    {
        ...
        if ($_SERVER['HTTP_REQUEST_ORIGIN'] == 'fetch') {
            ...
            $this->responseApi(1, 6, 'veiculos', $id, '', '');
    ...
    public function filter(Request $request, $array_dados)
    {
        ...
        if ($request->ajax()) {
            ...
            $this->responseApi(1, 3, 'veiculos', '', $array_dados, '');
