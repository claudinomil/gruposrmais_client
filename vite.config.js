    ...
    plugins: [
        ...
        viteStaticCopy({
            targets: [
                ...
                {src: 'resources/assets_template/js/scripts_materiais_listagem_geral.js', dest: 'assets'},
                {src: 'resources/assets_template/js/scripts_materiais_movimentacoes.js', dest: 'assets'},
                {src: 'resources/assets_template/js/scripts_materiais_controle_situacoes.js', dest: 'assets'},
