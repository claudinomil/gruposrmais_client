    ...
    plugins: [
        ...
        viteStaticCopy({
            targets: [
                ...
                {src: 'resources/assets_template/js/scripts_produtos.js', dest: 'assets'},
                {src: 'resources/assets_template/js/scripts_produtos_entradas.js', dest: 'assets'},
                {src: 'resources/assets_template/js/scripts_produtos_listagem_geral.js', dest: 'assets'},
                {src: 'resources/assets_template/js/scripts_produtos_movimentacoes.js', dest: 'assets'},
                {src: 'resources/assets_template/js/scripts_produtos_controle_situacoes.js', dest: 'assets'},
                ...
                {src: 'resources/assets_template/pdfs/produtos_entradas/pdf.pdf', dest: 'assets/pdfs/produtos_entradas'},
