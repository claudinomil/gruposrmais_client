    ...
    plugins: [
        ...
        viteStaticCopy({
            targets: [
                ...
                {src: 'resources/assets_template/js/scripts_ordens_servicos_pdfs.js', dest: 'assets'},
                {src: 'resources/assets_template/js/scripts_ordens_servicos_ost1.js', dest: 'assets'},
                {src: 'resources/assets_template/js/scripts_ordens_servicos_ost1_pdfs.js', dest: 'assets'},
                ...
                {src: 'resources/assets_template/js/scripts_propostas_pdfs.js', dest: 'assets'},
                {src: 'resources/assets_template/js/scripts_visitas_tecnicas.js', dest: 'assets'},
                {src: 'resources/assets_template/js/scripts_visitas_tecnicas_pdfs.js', dest: 'assets'},
                {src: 'resources/assets_template/js/scripts_visitas_tecnicas_vtt1.js', dest: 'assets'},
                {src: 'resources/assets_template/js/scripts_visitas_tecnicas_vtt1_pdfs.js', dest: 'assets'},
